  ...
  return (
    <div className="container w-full">
      <div className="item mb-2 md:flex md:flex-wrap md:justify-between">
        <div className="container w-full sm:px-8 min-w-full">
          ...
          <table className="min-w-full divide-y divide-gray-800">
            <thead className="sticky top-0 z-10 bg-gradient-to-b from-gray-900 to-black">
              <tr className="uppercase text-gray-300">
                ...
                <th
                  scope="col"
                  className="whitespace-nowrap px-2 py-3 text-sm font-medium text-gray-300 text-end"
                >
                  Action
                </th>
              </tr>
            ...
            <tbody className="divide-y divide-gray-800 bg-transparent">
              {domains.map((domain) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-2 py-3 text-sm text-end">
                    <Button
                      variant="secondary"
